                                ...
                                const AString & solutionMinimumVisualStudioVersion )
{
    ...
    int majorVsVersion;
    if ( sscanf_s(shortVersion.Get(), "%i", &majorVsVersion) != 1 )
    {
        majorVsVersion = 0;
    }
    ...
    // Visual Studio 2019 changed this wording slightly which meant that the
    // Visual Studio Version Selector could no longer recognize the solutions
    // generated by FastBuild for VS2019
    if ( majorVsVersion >= 16 )
    {
